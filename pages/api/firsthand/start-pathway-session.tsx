...
const PATHWAY_DEFINITION_ID = 'UtfVoEYLJ6hC'
const FIRSTHAND_API_KEY = process.env.FIRSTHAND_API_KEY || ''
      ...
      const body = JSON.stringify({
        ...
        variables: {
          input: {
            ...
            success_url: `${req.headers.origin}/demos/firsthand/?success=true`,
            cancel_url: `${req.headers.origin}/demos/firsthand/?canceled=true`,
          },
        },
      })
