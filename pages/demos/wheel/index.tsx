...
export default function HostedPathwayStory() {
  ...
  const onStartSession = async () => {
    const data = await fetch('/api/wheel/start-pathway-session', {
      method: 'POST',
      headers: {
  ...
  return (
    <form className="text-center">
      <div className="mx-auto text-center mb-12">
        <img
          src="https://cdn.healthtechalpha.com/static/startup_data_images/51359.png"
          width="120"
          className="mx-auto"
          alt="Wheel"
        />
