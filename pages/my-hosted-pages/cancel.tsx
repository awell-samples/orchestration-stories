...
export default function MyHostedPagesCancel() {
  return (
              ...
              <div className="relative bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden transform transition-all sm:my-8 sm:max-w-md sm:w-full sm:p-6">
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Your hosted page session was canceled. This is probably
                ...
                <div className="mt-5 sm:mt-6">
                  <button
                    ...
                    onClick={() => {
                      window.location.href = '/my-hosted-pages'
                    }}
                  >
                    Create a new hosted pages session
                  </button>
                </div>
              </div>
            </div>
