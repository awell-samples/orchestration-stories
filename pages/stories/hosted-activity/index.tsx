  ...
  return (
    <div className="max-w-xl mx-auto">
      <form onSubmit={handleSubmit(onStartSession)}>
        ...
        <button
          type="submit"
          className="mt-4 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600 disabled:cursor-not-allowed"
        >
          Start session
        </button>
      </form>
